    ...
    if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
        try {
            ...
            if ($user) {
                ...
                $mail->SMTPDebug = 2; // Affiche les journaux de débogage complets
...
";
                ...
                if ($mail->send()) {
                    echo "Email envoyé à : " . htmlspecialchars($email);
                    echo "Un e-mail de réinitialisation a été envoyé à : " . htmlspecialchars($email);
                } else {
