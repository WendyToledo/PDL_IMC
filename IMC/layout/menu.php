...
<div class="content">
    ...
    <div id="imc-section" class="section">
        ...
        <form id="form_imc" method="POST">
            ...
            <input type="text" name="taille" id="taille" placeholder="Indiquer votre taille" maxlength="3" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required>
            <label for="poids">Poids</label>
            <input type="text" name="poids" id="poids" placeholder="Indiquer votre poids" maxlength="3" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required>
            <input type="submit" value="Calculer IMC">
        </form>
        <div id="resultat_imc"></div>
    </div>
    ...
    <div id="tmb-section" class="section">
        ...
        <form id="form_tmb" method="POST">
            ...
            <input type="text" name="age" id="age" placeholder="Indiquer votre âge" maxlength="3" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required>
            <label for="poids_tmb">Poids</label>
            <input type="text" name="poids_tmb" id="poids_tmb" placeholder="Indiquer votre poids" maxlength="3" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required>
            <label for="taille_tmb">Taille</label>
            <input type="text" name="taille_tmb" id="taille_tmb" placeholder="Indiquer votre taille" maxlength="3" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required>
